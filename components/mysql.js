...
(async () => {
    await query(`create table if not exists messages ( id int auto_increment primary key, message longtext null, guild_id text not null, reactions longtext null, roles longtext null ) collate = utf8mb4_bin;`);
