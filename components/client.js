...
const commands = [
	new SlashCommandBuilder().setName("ping").setDescription("Valorant Customs Ping"),
	new SlashCommandBuilder()
		.setName("setmessage")
		.setDescription("Set customs ping message")
		.addStringOption((option) => option.setName("message").setDescription("The message to ping").setRequired(true)),
	new SlashCommandBuilder()
		.setName("setreactions")
		.setDescription("Set customs ping reactions")
		.addStringOption((option) => option.setName("reactions").setDescription("The reactions for ping (comma separated)").setRequired(true))
		.addStringOption((option) => option.setName("roles").setDescription("The roles to assign to each reaction (comma separated)").setRequired(true)),
	new SlashCommandBuilder()
		.setName("setday")
		.setDescription("Set day for customs ping")
		.addStringOption((option) => option.setName("day").setDescription("Day of the week (e.g. Sunday, Monday, etc.)").setRequired(true)),
	new SlashCommandBuilder().setName("setchannel").setDescription("Set channel for customs ping to current channel"),
];
...
client.on("ready", async () => {
	...
	res.forEach(async (row) => {
		try {
			...
			console.error("Error getting message on startup");
		}
	});
});
